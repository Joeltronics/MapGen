...
def main():
	...
	run_parser_parent = get_parser(add_help=False)
	run_parser = subparsers.add_parser('run', parents=[run_parser_parent])
	run_parser.set_defaults(func=run)

	process_parser_parent = process_data.get_parser(add_help=False)
	process_parser = subparsers.add_parser('process', parents=[process_parser_parent])
	process_parser.set_defaults(func=process_data.run)

	data_parser_parent = data.get_parser(add_help=False)
	data_parser = subparsers.add_parser('data', parents=[data_parser_parent])
